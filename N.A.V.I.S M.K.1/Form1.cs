...
namespace N.A.V.I.S_M.K._1
{
    public partial class Form1 : Form
    {
        ...
        {   
                ...
                {
                    case "say hello": MessageBox.Show("hello Jim"); break;
                    case "print my name": richTextBox1.Text += "\n Jim"; break;
                    case "open chrome": Process.Start("Chrome"); break;
                    case "open games": Process.Start(@"D:\Games"); break;
                    case "clock": var myForm = new clock(); myForm.Show(); break;
                    case "open minecraft": var path = Environment.ExpandEnvironmentVariables(@"D:\Games\Minecraft.exe"); Process.Start(path); break;
                    case "go to youtube": System.Diagnostics.Process.Start("http://youtube.com"); break;
                    case "open explorer":
                    ...
                    default: richTextBox1.Text += e.Result.Text + "\n"; break;
                }
        }
